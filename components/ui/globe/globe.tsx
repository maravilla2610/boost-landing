...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    if (!globeRef.current && groupRef.current) {
      ...
      // Mark initialized after mounting globe instance
...
export function WebGLRendererConfig() {
  ...
  useEffect(() => {
    (gl as WebGLRenderer).setPixelRatio(window.devicePixelRatio);
    (gl as WebGLRenderer).setSize(size.width, size.height);
    (gl as WebGLRenderer).setClearColor(0x000000, 0);
