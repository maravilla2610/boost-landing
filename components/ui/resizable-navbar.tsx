    ...
    >
      {items.map((item, idx) => (
        <a
          ...
          onClick={onItemClick}
          className="relative px-4 py-2 text-gray-300 hover:text-grey"
          key={`link-${idx}`}
          href={item.link}
        >
          {hovered === idx && (
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    dark: "px-8 py-0.5  border-2 border-black dark:border-primary uppercase bg-primary text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(246,242,71),2px_2px_rgba(246,242,71),3px_3px_rgba(246,242,71),4px_4px_rgba(246,242,71),5px_5px_0px_0px_rgba(246,242,71)] ",
    gradient:
